...
<html lang="en">
    <head>
        ...
        <title>Admin Settings | LEGATO</title>
    ...
    <main>
        <section class="page-hero">
            <div class="container">
                ...
                <h1>Account <em>Settings.</em>
            </h1>
            <p>Manage your operations credentials and team access.</p>
        </div>
    </section>
    <section class="inner-section">
        <div class="container settings-grid">
            <section class="admin-panel">
                <p class="section-label">YOUR ACCESS</p>
            ...
            <?php if ($admin['role'] === 'super_admin'): ?>
                <section class="admin-panel">
                    ...
                    <label>Temporary password<input name="password" type="password" minlength="8" required>
                    </label>
                ...
                <div class="team-list">
                    <?php foreach ($team as $member): ?>
                        <div>
                            <strong>
                                <?php echo escaped($member['full_name']); ?>
                            </strong>
                            <span>
                                <?php echo escaped($member['email']); ?> · <?php echo escaped($member['role']); ?>
                            </span>
                        </div>
                    <?php endforeach; ?>
                </div>
