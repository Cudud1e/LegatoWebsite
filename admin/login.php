...
<html lang="en">
    <head>
        ...
        <title>Admin Login | LEGATO</title>
    ...
    <body class="inner-page">
        <main class="auth-section">
            <form class="auth-card" method="post">
                ...
                <label for="email">Admin email<input id="email" name="email" type="email" required value="<?php echo escaped($email); ?>">
                </label>
                <label for="password">Password<input id="password" name="password" type="password" required>
                </label>
                <button class="btn btn-gold full-width" type="submit">Sign In</button>
                <?php if ($error): ?>
